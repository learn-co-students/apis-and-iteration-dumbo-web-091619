...
def welcome_user_and_get_user_input
  puts "Welcome to the Star Wars Movie Apllication"
  puts "Which character do you want to search"
  gets.chomp.downcase
end
...
def get_character_movies_from_api(character_name)
  character_object = find_charcter_from_api(character_name)
  films = character_object["films"]
  film_objects = take_film_urls_and_return_film_object(films)
